  ...
  return (
    <>
      <div className="bg-black pt-10">
        <h1 className="text-center text-4xl font-semibold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 pb-2">
          Pricing that suits you
        </h1>
        <p className="text-center text-neutral-400">Hover to reveal</p>
      </div>
      <div className="py-10 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-black w-full gap-4 mx-auto px-8">
        <Card
          title="$0/month"
          icon={<div className="text-3xl font-bold text-white">Beginner</div>}
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title="$10/month"
          icon={
            <div className="text-3xl font-bold text-white">Intermediate</div>
          }
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title="$15/month"
          icon={<div className="text-3xl font-bold text-white">Advanced</div>}
        >
          <CanvasRevealEffect
            animationSpeed={3}
